...
- `npm run start:vite` - Запуск fronted проекта на vite
- `npm run start:dev` - Запуск fronted проекта на webpack dev server + backend
- `npm run start:dev:vite` - Запуск fronted проекта на vite + backend
- `npm run build:prod` - Сброка проекта в prod режиме
- `npm run build:dev` - Сброка проекта в dev режиме(не минимизирован)
- `npm run lint:ts` - Проверка ts файлов проекта ts-линтером
- `npm run lint:ts:fix` - Проверка ts файлов проекта и исправление ts-линтером
- `npm run lint:scss` - Проверка scss файлов проекта style-линтером
...
используется собственный eslint plugin _eslint-production-app-plugin_,
