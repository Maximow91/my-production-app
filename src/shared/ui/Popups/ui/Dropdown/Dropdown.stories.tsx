...
export const NormalTopLeft: Story = {
    render: () => (
        <Dropdown direction='top left' trigger={<CustomButton>Open</CustomButton>} items={items} />
    )
}

export const NormalTopRight: Story = {
    render: () => (
        <Dropdown direction='top right' trigger={<CustomButton>Open</CustomButton>} items={items} />
    )
}

export const NormalBottomLeft: Story = {
    render: () => (
        <Dropdown direction='bottom left' trigger={<CustomButton>Open</CustomButton>} items={items} />
    )
}

export const NormalBottomRight: Story = {
    render: () => (
        <Dropdown direction='bottom right' trigger={<CustomButton>Open</CustomButton>} items={items} />
    )
}
